...
<div id="sfoglia_file_menu">
	...
	<div id="info_file">
					...
					onMouseOut="window.parent.document.getElementById('img_cambia').src=('core/img/xbmc.png');">&ensp;&ensp;&ensp; <?php echo $t_cerca_musica ; ?>
					
					</a></div> 
					
					<div id="playlist"><a href="cerca_musica.php"></a></div>
					<div id="type"    ><a href="cerca_musica.php"><img src="img/back.png" width="28" height="28"/></a></div>
					
	</div>
	
	<div id="info_file">
			
					<div id="title"   >&ensp;&ensp;&ensp;&ensp;&ensp;&ensp; <?php echo $t_cerca_artista ; ?></div> 
					<div id="playlist"></div>
					<div id="type"    ></div>
...
<form id="form" name="form" method="get" action="artisti.php">
<ul>
