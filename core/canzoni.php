		...
		if ( $_GET['Submit'] == "Cerca"){
			...
			if ( preg_match("%$ricerca%", $value['label']) or preg_match("%$ricerca2%", $value['label']) ) {
				...
				<div id="info_file">
					...
					<div id="type"    ><a href="canzoni_cerca.php"><img src="img/back.png" width="28" height="28"/></a></div>
				...
				<div id="info_file">
						...
						<div id="title"   ><a href="play.php?metod=songid&id='.$value['file'].'&title='.$value['label'].'" target="control" onMouseOver="window.parent.document.getElementById(\'img_cambia\').src=(';
						...
						<div id="playlist"><a href="play.php?metod=songid&id='.$value['file'].'&title='.$value['label'].'" target="control"></a></div>
						<div id="type"    ><a href="play.php?metod=songid&id='.$value['file'].'&title='.$value['label'].'" target="control">';
