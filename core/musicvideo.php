		...
		if ( $_GET['Submit'] == "Cerca"){
			...
			if ( preg_match("%$ricerca%", $value['label']) or preg_match("%$ricerca2%", $value['label']) ) {
				...
				<div id="info_file">
					...
					<div id="type"    ><a href="videomusic_cerca.php"><img src="img/back.png" width="28" height="28"/></a></div>
				...
				<div id="info_file">
						...
						<div id="title"   ><a href="play.php?metod=musicvideoid&id='.$value['file'].'&title='.$value['label'].'" target="control" onMouseOver="CambiaImmaginequadro(';
						...
						<div id="playlist"><a href="play.php?metod=musicvideoid&id='.$value['file'].'&title='.$value['label'].'" target="control">'.$value['artist'].'</a></div>
						<div id="type"    ><a href="play.php?metod=musicvideoid&id='.$value['file'].'&title='.$value['label'].'" target="control">';
