		...
		if ( $_GET['Submit'] == "Cerca"){
			...
			if ( preg_match("%$ricerca%", $value['label']) or preg_match("%$ricerca2%", $value['label']) ) {
				...
				<div id="info_file">
					...
					<div id="type"    ><a href="artisti_cerca.php"><img src="img/back.png" width="28" height="28"/></a></div>
				...
				<div id="info_file">
						...
						<div id="title"   ><a href="artisti_canzoni.php?&artistid='.$value['artistid'].'&title='.$value['label'].'" target="info" onClick="InfoApri()" onMouseOver="CambiaImmaginequadro(';
						...
						<div id="playlist"><a href="artisti_canzoni.php?&artistid='.$value['artistid'].'&title='.$value['label'].'" target="info" onClick="InfoApri()"></a></div>
						<div id="type"    ><a href="artisti_canzoni.php?&artistid='.$value['artistid'].'&title='.$value['label'].'" target="info" onClick="InfoApri()">';
